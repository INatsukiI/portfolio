...
export const DESKTOP_ICONS: Array<{ id: string; label: string; kind: IconKey; launchOnly?: boolean }> = [
  ...
  { id: 'terminal', label: 'terminal.app', kind: 'terminal', launchOnly: true },
...
export const WIN_DEFAULTS: Record<string, WindowDefault> = {
  readme:   { title: 'welcome.txt — メモ帳',    icon: 'readme',   x: 280, y: 60,  w: 460, h: 560 },
  ...
  terminal: { title: 'terminal.app',               icon: 'terminal', x: 200, y: 80,  w: 620, h: 480 },
